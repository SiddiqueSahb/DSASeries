...
2.CREATING 4 VAR AND INITIALIZE TO NULL 
 ...
 11.ATTACH BOTH EVEN AND ODD LINKED LIST BY MAKING ODDT->NEXT  = EVENH BUT BEFORE THAT CHECK FOR CORNER CASES TO GET  THE PROPER INSIGHT ABOUT THE CONDITIONS.
 //CORNER CASES
 IF LL IS EVEN 
 IF LL IS ODD
