...
//APPROACH
/*
1.store root left child in some temmporary variable and root right child to moved to left
2.then from temp roots left child is moved to right
3.do this for LST and RST
