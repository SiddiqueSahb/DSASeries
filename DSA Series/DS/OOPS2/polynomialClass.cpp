...
class Polynomial {
    ...
    Polynomial (Polynomial const &p){
        //Doing Deep copy - i.e creating new array
    ...
    //here degree means index of an array and at that index value i.e coeff is present
    void setCoefficient(int deg,int coef){
        //if deg(index) of an array is greater than capacity of array
        if(deg>capacity){
            int newcapacity=deg;
            int *newdeg=new int[newcapacity+1];
            //Copy the contents from original array to new array
