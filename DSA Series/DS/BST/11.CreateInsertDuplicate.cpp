...
2.CHECK IF ROOT IS HAVING LEFT CHILD , IF LEFT CHILD IS PRESENT
3.CREATE A ROOT NODE DUPLICATE , MAKE A TEMP POINTER AND STORE ADD OF ROOT'S LEFT CHILD IN IT OTHERWISE IT WILL BE LOST
4.ATTACH DUPLICATE NODE WITH ROOT NODE AND ITS LEFT CHILD
5.DO THIS FOR LST AND RST
*/
...
void insertDuplicateNode(BinaryTreeNode<int> *root) {
    ...
    //ROOT->LEFT->LEFT WILL BE NEXT NODE AFTER INSERTION OF DUPLICATE NODE.
