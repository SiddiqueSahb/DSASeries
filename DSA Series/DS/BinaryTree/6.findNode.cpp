...
************************************************************/
//initially we are checking and then traversing the node for lst and rst
...
************************************************************/
//here we are traversing (i.e going till end ) and then comparing each node 
//we are going top to bottom ,then start comparing from bottom to top 
bool isNodePresent(BinaryTreeNode<int> *root, int x) {
    // Write your code here
