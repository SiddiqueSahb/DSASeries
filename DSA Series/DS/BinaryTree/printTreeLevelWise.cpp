...
3.untill queue is not empty , do pop and for each element check if its left child exist print leftchild and push to queue and if rightChild exists print rightChild and push to queue.
*/
